...
PingPongTable.prototype = {
    ...
    init: function(scene) {
        ...
        this.table = new THREE.Mesh(new THREE.CubeGeometry(this.height, this.width, 1), new THREE.MeshBasicMaterial({
            map: tableImage
        }));
        ...
        this.net = new THREE.Mesh(new THREE.CubeGeometry(this.height, this.netHeight, 1), new THREE.MeshBasicMaterial({
            map: netImage,
            transparent: true
        }));
